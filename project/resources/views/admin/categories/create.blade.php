          ...
          <div class="m-2 p-2 bg-slate-100 rounded">
              <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                <div class="sm:col-span-6">
                  ...
                  <div class="mt-1">
                    <input type="text" id="name" wire:model.lazy="name" name="name" class="block w-full transition ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal duration-150 sm:text-sm sm:leading-5" />
                  </div>
                </div>
                <div class="sm:col-span-6">
